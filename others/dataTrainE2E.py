...
def train(math_path,ruler_path,learning_rate,batch_size,epoch_num,model_path,init=True): 
    ...
    for epoch in range(num_epochs):
        ...
        print(f'{epoch+1},{loss1.item()},{loss2.item()},{class_accuracy},{dect_accuracy}')
    
train('data/origin/train9to12/','data/origin/train9to12/',0.001,40,60,'out/originmodel/e2e')
#     total_correct = 0
