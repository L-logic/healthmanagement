# from modelutil.TransformerModel import train,test
...
# from modelutil.E2ELSTM import train,test
...
def Train():
    model_path = 'out/model/Transformer'
    train(tra_math_path,tra_ruler_path,learning_rate,batch_size,epoch_num,model_path,init=True)
def Test():
    for i in range(60):
        result_path = f'out/test/CNNRE/res{i+1}.csv'
        model_path = f'out/model/CNNRE/model{i+1}.pkl'
